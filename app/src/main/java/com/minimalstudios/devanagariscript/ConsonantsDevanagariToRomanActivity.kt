...
import com.minimalstudios.devanagariscript.databinding.ActivityConsonantsDevanagariToRomanBinding

class ConsonantsDevanagariToRomanActivity : BaseCharacterLogicActivity() {

    private lateinit var binding: ActivityConsonantsDevanagariToRomanBinding

    override val mappingUsed = mapConsonantDevanagariToRoman

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityConsonantsDevanagariToRomanBinding.inflate(layoutInflater)
